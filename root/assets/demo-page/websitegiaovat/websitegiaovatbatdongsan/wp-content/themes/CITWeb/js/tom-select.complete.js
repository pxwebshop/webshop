	...
	*/
	...
	class TomSelect extends MicroPlugin(MicroEvent) {
	  ...
	  onKeyDown(e) {
	    ...
	    if ((self.isFull() || self.isInputHidden) && !isKeyDown(KEY_SHORTCUT, e)) {
	      preventDefault(e);
	    }
	  }
	  /**
	  ...
	  onBlur() {
	    ...
	    var deactivate = () => {
	      ...
	      self.trigger('blur');
			...
			if (this.settings.chooseItemOnBlur && this.activeOption) {
				this.onOptionSelect({ type: 'click' }, this.activeOption);
			}
		 ...
		 */
		 onOptionHover(elem) {
			if (this.ignoreHover) return;
				this.setActiveOption(elem, false);
		}
	  /**
	  ...
	  refreshOptions(triggerDropdown = true) {
	    ...
	    var dropdown_content = self.dropdown_content;
			if(dropdown_content.querySelectorAll("[data-selectable]").length > 0){
				dropdown_content.querySelectorAll("[data-selectable]").forEach(function(elem, index){
					addEvent(elem, 'mouseenter', () => self.onOptionHover(elem));
				});
			}
